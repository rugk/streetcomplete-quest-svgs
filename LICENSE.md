...
building_icons.svg
    ...
    carport                     parts taken from Twemoji 2: U+1F698
    civic
    college
    commercial
    detached
    ...
    farm
    farm2
    garage                      parts taken from Twemoji 2: U+1F698
    garages                     parts taken from Twemoji 2: U+1F698
    greenhouse
    hospital
    hotel
    house
    houseboat                   parts taken from Twemoji 2: U+26F4
    hut
    industrial
    kindergarten
    kiosk
    other
    parking                     parts taken from Twemoji 2: U+1F698
    retail
    roof
    school
    semi-detached
    service
    shed
    stadium                     EmojiOne 2: U+1F3D0
    static_caravan
    storage_tank
    temple
    terrace
    train_station               modified from Twemoji 2: U+1F689
    transportation              modified from Twemoji 2: U+1F68D
    university
    warehouse
...
quest_icons.svg
	apple
	baby						modified from Twemoji 2: U+1F6BC
	beer						modified from Twemoji 2: U+1F37A
	bench
	bicycle
	bicycle_parking
	bicycle_parking_capacity
	bicycle_parking_cover
	bicycleway
	bicycleway_width
	blind
	...
	bus                        modified from Twemoji 2: U+1F68D
	bus_shelter                parts taken from Twemoji 2: U+1F68D
	bus_stop_name              parts taken from Twemoji 2: U+1F68D
	car							modified from Twemoji 2: U+1F698
	...
	pedestrian
	pedestrian_crossing
	pedestrian_segregated
	phone
	power
	quest
	restaurant					modified from Twemoji 2: U+1F37D
	restaurant_vegan			parts taken from Twemoji 2: U+1F37D and U+1F955
	restaurant_vegetarian		parts taken from Twemoji 2: U+1F37D and U+1F955
	railway
	road_construction
	roof_shape
